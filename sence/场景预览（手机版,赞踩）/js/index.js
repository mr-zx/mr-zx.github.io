...
//更新当前页码
function updatePageNow(index) {
    $("#pageNow").html(index);
}
/**
 * 绑定超链接图片的点击事件
 **/
function bindImgClickToUrl() {
    $("img.linkImg").each(function () {
        $(this).click(function () {
...
function getAllSlidesJson() {
    ...
    if (json.slideType == '3' || json.slideType == '4') {
        $('head').append('<script src="js/slideType.mobile.js"></script>');
    }
